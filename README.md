...
### 1. Create it .env in the root of the project, or run the file init_env.py:
...
### 4. Getting a certificate (at the first launch):
...
### 5. It is necessary to uncomment parts of the code in nginx/nginx.conf. It is necessary to uncomment parts of the code in nginx/nginx.conf. Then rebuild docker compose:
